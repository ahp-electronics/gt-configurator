...
void MainWindow::readIni(QString ini)
{
    ...
    ui->TrackRate_0->setValue(-(settings->value("TimingValue_0", ahp_gt_get_timing(0)).toInt()-AHP_GT_ONE_SECOND)/AHP_GT_ONE_SECOND*100000.0);
    ...
    ui->TrackRate_1->setValue(-(settings->value("TimingValue_1", ahp_gt_get_timing(1)).toInt()-AHP_GT_ONE_SECOND)/AHP_GT_ONE_SECOND*100000.0);
    ...
    ahp_gt_set_timing(0, (GT1SteppingConfiguration)-ui->TrackRate_0->value()*AHP_GT_ONE_SECOND/100000.0+AHP_GT_ONE_SECOND);
    ...
    ahp_gt_set_timing(1, (GT1SteppingConfiguration)-ui->TrackRate_1->value()*AHP_GT_ONE_SECOND/100000.0+AHP_GT_ONE_SECOND);
...
void MainWindow::saveIni(QString ini)
{
    ...
    settings->setValue("TimingValue_0", ui->TrackRate_0->value()*AHP_GT_ONE_SECOND/100000.0+AHP_GT_ONE_SECOND);
    ...
    settings->setValue("TimingValue_1", ui->TrackRate_1->value()*AHP_GT_ONE_SECOND/100000.0+AHP_GT_ONE_SECOND);
    ...
    , ui(new Ui::MainWindow)
{
    ...
    {
        ahp_gt_set_timing(0, AHP_GT_ONE_SECOND + AHP_GT_ONE_SECOND * -value / 100000.0);
        saveIni(ini);
    });
    connect(ui->TrackRate_1, static_cast<void (QSlider::*)(int)>(&QSlider::valueChanged), [ = ] (int value)
    {
        ahp_gt_set_timing(1, AHP_GT_ONE_SECOND + AHP_GT_ONE_SECOND * -value / 100000.0);
        saveIni(ini);
    });
...
void MainWindow::UpdateValues(int axis)
{
    ...
    if(axis == 0)
    {
        ...
        ui->TrackRate_0->setValue(-(ahp_gt_get_timing(0)-AHP_GT_ONE_SECOND)*100000.0/AHP_GT_ONE_SECOND);
    ...
    else if (axis == 1)
    {
        ...
        ui->TrackRate_1->setValue(-(ahp_gt_get_timing(1)-AHP_GT_ONE_SECOND)*100000.0/AHP_GT_ONE_SECOND);
