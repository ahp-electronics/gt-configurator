...
void MainWindow::readIni(QString ini)
{
    ...
    ahp_gt_set_timing(0, AHP_GT_ONE_SECOND-ui->TrackRate_0->value()*AHP_GT_ONE_SECOND/100000.0);
    ...
    ahp_gt_set_timing(1, AHP_GT_ONE_SECOND-ui->TrackRate_1->value()*AHP_GT_ONE_SECOND/100000.0);
...
void MainWindow::UpdateValues(int axis)
{
    ...
    if(axis == 0)
    {
        ...
        ui->TrackRate_label_0->setText("Track Rate offset: " + QString::number((double)ui->TrackRate_0->value()/1000.0) + "%");
    }
    else if (axis == 1)
    {
        ...
        ui->TrackRate_label_1->setText("Track Rate offset: " + QString::number((double)ui->TrackRate_1->value()/1000.0) + "%");
    }
